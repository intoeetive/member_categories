<?=form_open('C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=member_categories'.AMP.'method=save', array('id'=>'member_categories_edit_form'));?>
...
<li class="content_tab "> <a href="<?=BASE.AMP.'C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=member_categories'.AMP.'method=mass_assign'?>"><?=lang('mass_assign')?></a>  </li> 
